       ...
       @foreach ($posts as $post)
        <tr>
            ...
            <td>
                ...
                <div class="modal fade" id="delete{{$post->id}}" tabindex="-1" aria-labelledby="modal-{{$post->id}}Label" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="{{$post->id}}Label">Stai cercanando di cancellare il post {{$post->title}}</h5>

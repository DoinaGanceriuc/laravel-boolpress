        ...
        <form action="{{ route('admin.posts.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                    aria-describedby="titleHelper" placeholder="Scrivi qui il titolo del post" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="posted_at" id="posted_at"
                    ...
                    placeholder="Indicare la data nel formato YYYY-MM-DD" value="{{ old('posted_at') }}">
                @error('posted_at')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
